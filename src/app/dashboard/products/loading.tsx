    ...
    <div className="space-y-6 animate-pulse font-inter p-4">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          ...
          <div className="h-4 w-80 bg-slate-100 dark:bg-slate-900 rounded-md"></div>
        </div>
              ...
              {[1, 2, 3, 4, 5, 6].map((row) => (
                <tr key={row}>
                  ...
                  <td className="px-6 py-5">
                    <div className="h-6 w-24 bg-slate-50 dark:bg-slate-800 rounded-lg"></div>
                  </td>
                  <td className="px-6 py-5">
                    <div className="h-6 w-12 bg-slate-50 dark:bg-slate-800 rounded-lg"></div>
                  </td>
                  <td className="px-6 py-5">
                    <div className="h-6 w-16 bg-slate-50 dark:bg-slate-800 rounded-lg"></div>
                  </td>
